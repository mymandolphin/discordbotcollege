...
class voice(commands.Cog):
    ...
    async def join(self,ctx):
        ...
        if voice and voice.is_connected():
            ...
            if voice.channel == channel:
                ...
                await ctx.send(embed=discord.Embed(title="You are already in a call with me",colour=0xffff00))
    ...
    async def leave(self,ctx):
        ...
        if voicestate is None:
            ...
            return await ctx.send(embed=discord.Embed(title='You are not in a voice channel',colour=0xffff00))
