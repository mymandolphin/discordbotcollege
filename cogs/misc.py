...
class Misc(commands.Cog):
    ...
    async def invite(self,ctx):
        ...
        embed = discord.Embed(
            ...
            title= "Wanna add WaterBot to your own server?",
            description="Click [here](https://discord.com/api/oauth2/authorize?client_id=812352738061975642&permissions=8&scope=bot) to use this bot in your own server!",
            colour=0x33e18d
